...
export type Equipment = { id: string; clientId: string; category: 'Eletrônico' | 'Energia solar' | 'Elétrico' | 'Instalação de ar-condicionado split'; brand: string; model: string; serial: string; color?: string; voltage?: string; accessories?: string; condition?: string; notes: string };
