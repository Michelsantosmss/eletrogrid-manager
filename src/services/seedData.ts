...
export const quoteSeed: Quote[] = [
  { id: 'orc-1', serviceOrderId: 'os-2', parts: 980, labor: 420, discount: 80, approved: false },
];

export const financeSeed: FinanceEntry[] = [
  { id: 'fin-1', type: 'Receber', description: 'Sinal orçamento OS-2', amount: 600, dueDate: '2026-07-20', paid: false },
  { id: 'fin-2', type: 'Pagar', description: 'Fornecedor placa comunicação', amount: 520, dueDate: '2026-07-18', paid: true },
];
