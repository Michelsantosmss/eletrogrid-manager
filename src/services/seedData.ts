...
export const quoteSeed: Quote[] = [{ id: 'orc-1', serviceOrderId: 'os-2', items: [{ id: 'item-1', description: 'Placa de comunicação', kind: 'Peça/material', quantity: 1, unitPrice: 980 }, { id: 'item-2', description: 'Substituição, configuração e testes', kind: 'Serviço', quantity: 1, unitPrice: 420 }], discount: 80, deadline: '5 dias úteis', warranty: '90 dias sobre o serviço executado', notes: 'Execução após aprovação do cliente.', approved: false }];
