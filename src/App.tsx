...
function App() {
  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      {activeModule === 'Dashboard' && <Dashboard clients={clients.length} equipment={equipment.length} demo={demo}/>}
...
function Dashboard({ clients, equipment, demo }: { clients: number; equipment: number; demo: boolean }) { return <OperationsDashboard clients={clients} equipment={equipment} demo={demo}/>; }
